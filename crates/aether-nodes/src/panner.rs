...
impl DspNode for Panner {
    ...
    fn type_name(&self) -> &'static str { "Panner" }
}
...
mod tests {
    ...
    fn test_panner_center() {
        ...
        for &v in &[0.0f32, 1.0] { params.add(v); }
        ...
        assert!(output[0] > 0.2 && output[0] < 0.8, "center pan should preserve level, got {}", output[0]);
    }
    ...
    fn test_panner_hard_left() {
        ...
        for &v in &[-1.0f32, 1.0] { params.add(v); }
    ...
    fn test_panner_mono_width() {
        ...
        for &v in &[0.0f32, 0.0] { params.add(v); }
        ...
        assert!(output[0] > 0.2 && output[0] < 0.8, "mono width should collapse stereo, got {}", output[0]);
    }
}
